...
//    }
    ...
    public static void store(String key, Object value, long time, TimeUnit timeUnit) {
        //EX: cache.put(key, value, 1, TimeUnit.MINUTES);
//        cache.put(key, value, time, timeUnit);
    ...
    public static boolean isTokenExpired(TokenData tokenData) {
